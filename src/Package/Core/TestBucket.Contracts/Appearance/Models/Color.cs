...
//// Stripped and adapted by Meinrad Recheis and Benjamin Kappel for Blazor

// Based on https://github.com/Blazor/Blazor
...
/// </summary>
[Serializable]
public partial class ThemeColor : ISerializable, IEquatable<ThemeColor>, IParsable<ThemeColor>, IFormattable
{
    ...
    /// <summary>
    /// Deserialization constructor for <see cref="ThemeColor"/>.
    /// </summary>
    /// <param name="info">The <see cref="SerializationInfo"/>> containing the serialized data.</param>
    /// <param name="context">The <see cref="StreamingContext"/>>.</param>
    protected ThemeColor(SerializationInfo info, StreamingContext context) :
        this(info.GetByte(nameof(R)), info.GetByte(nameof(G)), info.GetByte(nameof(B)), info.GetByte(nameof(A)))
    {
    }

    /// <summary>
    /// Constructs a default instance of <see cref="ThemeColor"/> with default values (black with full opacity).
    /// </summary>
    public ThemeColor()
    {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ThemeColor"/> class with the specified hue, saturation, lightness, and alpha values.
    /// </summary>
    ...
    public ThemeColor(double h, double s, double l, double a)
        : this(h, s, l, (int)(a * 255.0))
    {
    }
    ...
    public ThemeColor(double h, double s, double l, int a)
    {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ThemeColor"/> class with the specified red, green, blue, and alpha values.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ThemeColor"/> class with the specified color.
    /// </summary>
    /// <param name="rgba">the four bytes of this 32-bit unsigned integer contain the red, green, blue and alpha components</param>
    public ThemeColor(uint rgba)
        : this(r: (byte)(rgba >> 24), g: (byte)(rgba >> 16), b: (byte)(rgba >> 8), a: (byte)rgba)
    {
    }

    /// <summary>
    /// Initializes a new instance of the <see cref="ThemeColor"/> class with the specified red, green, blue, and alpha values, copying the hue value from the provided color.
    /// </summary>
    /// <param name="r">The red component value (0 to 255).</param>
    /// <param name="g">The green component value (0 to 255).</param>
    /// <param name="b">The blue component value (0 to 255).</param>
    /// <param name="ThemeColor">The existing color to copy the hue value from.</param>
    public ThemeColor(byte r, byte g, byte b, ThemeColor color) : this(r, g, b, color.A)
    {
        _hsl = _hsl with { H = color.H };
    }

    /// <summary>
    /// Initializes a new instance of the <see cref="ThemeColor"/> class with the specified RGB values and alpha component.
    /// </summary>
    /// <param name="r">The red component value (0 to 255).</param>
    /// <param name="g">The green component value (0 to 255).</param>
    /// <param name="b">The blue component value (0 to 255).</param>
    /// <param name="alpha">The alpha component value (0.0 to 1.0).</param>
    public ThemeColor(int r, int g, int b, double alpha)
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ThemeColor"/> class with the specified string representation of a color.
    /// </summary>
    ...
    /// <summary>
    /// Creates a new <see cref="ThemeColor"/> instance with the specified hue value while keeping the saturation, lightness, and alpha values unchanged.
    /// </summary>
    /// <param name="h">The hue component value (0 to 360).</param>
    /// <returns>A new <see cref="ThemeColor"/> instance with the specified hue value.</returns>
    public ThemeColor SetH(double h) => new(h, S, L, A);

    /// <summary>
    /// Creates a new <see cref="ThemeColor"/> instance with the specified saturation value while keeping the hue, lightness, and alpha values unchanged.
    /// </summary>
    /// <param name="s">The saturation component value (0.0 to 1.0).</param>
    /// <returns>A new <see cref="ThemeColor"/> instance with the specified saturation value.</returns>
    public ThemeColor SetS(double s) => new(H, s, L, A);

    /// <summary>
    /// Creates a new <see cref="ThemeColor"/> instance with the specified lightness value while keeping the hue, saturation, and alpha values unchanged.
    /// </summary>
    /// <param name="l">The lightness component value (0.0 to 1.0).</param>
    /// <returns>A new <see cref="ThemeColor"/> instance with the specified lightness value.</returns>
    public ThemeColor SetL(double l) => new(H, S, l, A);

    /// <summary>
    /// Creates a new <see cref="ThemeColor"/> instance with the specified red component value while keeping the green, blue, and alpha values unchanged.
    /// </summary>
    /// <param name="r">The red component value (0 to 255).</param>
    /// <returns>A new <see cref="ThemeColor"/> instance with the specified red component value.</returns>
    public ThemeColor SetR(int r) => new(r, G, B, A);

    /// <summary>
    /// Creates a new <see cref="ThemeColor"/> instance with the specified green component value while keeping the red, blue, and alpha values unchanged.
    /// </summary>
    /// <param name="g">The green component value (0 to 255).</param>
    /// <returns>A new <see cref="ThemeColor"/> instance with the specified green component value.</returns>
    public ThemeColor SetG(int g) => new(R, g, B, A);

    /// <summary>
    /// Creates a new <see cref="ThemeColor"/> instance with the specified blue component value while keeping the red, green, and alpha values unchanged.
    /// </summary>
    /// <param name="b">The blue component value (0 to 255).</param>
    /// <returns>A new <see cref="ThemeColor"/> instance with the specified blue component value.</returns>
    public ThemeColor SetB(int b) => new(R, G, b, A);

    /// <summary>
    /// Creates a new <see cref="ThemeColor"/> instance with the specified alpha value while keeping the red, green, blue values unchanged.
    /// </summary>
    /// <param name="a">The alpha component value (0 to 255).</param>
    /// <returns>A new <see cref="ThemeColor"/> instance with the specified alpha component value.</returns>
    public ThemeColor SetAlpha(int a) => new(R, G, B, a);
    ...
    /// <returns>A new <see cref="ThemeColor"/> instance with the specified alpha component value.</returns>
    public ThemeColor SetAlpha(double a) => new(R, G, B, a);

    /// <summary>
    /// Creates a new <see cref="ThemeColor"/> instance by adjusting the lightness component value by the specified amount.
    /// </summary>
    /// <param name="amount">The amount to adjust the lightness by (-1.0 to 1.0).</param>
    /// <returns>A new <see cref="ThemeColor"/> instance with the adjusted lightness.</returns>
    public ThemeColor ChangeLightness(double amount) => new(H, S, Math.Max(0, Math.Min(1, L + amount)), A);

    /// <summary>
    /// Creates a new <see cref="ThemeColor"/> instance by lightening the color.
    /// </summary>
    /// <param name="amount">The amount to lighten the color by.</param>
    /// <returns>A new <see cref="ThemeColor"/> instance that is lighter than the original color.</returns>
    public ThemeColor ColorLighten(double amount) => ChangeLightness(+amount);

    /// <summary>
    /// Creates a new <see cref="ThemeColor"/> instance by darkening the color.
    /// </summary>
    /// <param name="amount">The amount to darken the color by.</param>
    /// <returns>A new <see cref="ThemeColor"/> instance that is darker than the original color.</returns>
    public ThemeColor ColorDarken(double amount) => ChangeLightness(-amount);

    /// <summary>
    /// Creates a new <see cref="ThemeColor"/> instance by lightening the color using the RGB algorithm.
    /// </summary>
    /// <returns>A new <see cref="ThemeColor"/> instance that is lighter than the original color.</returns>
    public ThemeColor ColorRgbLighten() => ColorLighten(0.075);

    /// <summary>
    /// Creates a new <see cref="ThemeColor"/> instance by darkening the color using the RGB algorithm.
    /// </summary>
    /// <returns>A new <see cref="ThemeColor"/> instance that is darker than the original color.</returns>
    public ThemeColor ColorRgbDarken() => ColorDarken(0.075);

    /// <summary>
    /// Checks whether the HSL (Hue, Saturation, Lightness) values of this <see cref="ThemeColor"/> instance are equal compared to another <see cref="ThemeColor"/> instance.
    /// </summary>
    /// <param name="other">The <see cref="ThemeColor"/> instance to compare HSL values with.</param>
    /// <returns>True if the HSL are equal; otherwise, false.</returns>
    public bool HslEquals(ThemeColor? other) => other is not null && _hsl.Equals(other._hsl);

    /// <summary>
    /// Checks whether the RGBA (Red, Green, Blue, Alpha) values of this <see cref="ThemeColor"/> instance are equal compared to another <see cref="ThemeColor"/> instance.
    /// </summary>
    /// <param name="other">The <see cref="ThemeColor"/> instance to compare HSL values with.</param>
    /// <returns>True if the RGBA are equal; otherwise, false.</returns>
    public bool RgbaEquals(ThemeColor? other) => other is not null && _rgba.Equals(other._rgba);

    /// <inheritdoc />
    public override bool Equals(object? obj) => obj is ThemeColor color && Equals(color);

    /// <summary>
    /// Determines whether this <see cref="ThemeColor"/> instance is equal to another <see cref="ThemeColor"/> instance.
    /// </summary>
    /// <param name="other">The <see cref="ThemeColor"/> instance to compare.</param>
    ...
    public string ToString(string? format, IFormatProvider? formatProvider)
    {
        ...
        {
            "rgb" => ToString(ColorOutputFormats.RGB),
            "rgba" => ToString(ColorOutputFormats.RGBA),
            "hex" => ToString(ColorOutputFormats.Hex),
            "hexa" => ToString(ColorOutputFormats.HexA),
            "colorelements" => ToString(ColorOutputFormats.ColorElements),
            _ => Value
        };
    }

    /// <summary>
    /// Deconstructs the <see cref="ThemeColor"/> into its red, green, and blue components.
    /// </summary>
    /// <param name="r">The red component value (0 to 255).</param>
    /// <param name="g">The green component value (0 to 255).</param>
    /// <param name="b">The blue component value (0 to 255).</param>
    ...
    /// <summary>
    /// Deconstructs the <see cref="ThemeColor"/> into its red, green, blue, and alpha components.
    /// </summary>
    /// <param name="r">The red component value (0 to 255).</param>
    /// <param name="g">The green component value (0 to 255).</param>
    /// <param name="b">The blue component value (0 to 255).</param>
    ...
    /// <summary>
    /// Determines whether two <see cref="ThemeColor"/> instances are not equal.
    /// </summary>
    /// <param name="lhs">The first <see cref="ThemeColor"/> instance to compare.</param>
    /// <param name="rhs">The second <see cref="ThemeColor"/> instance to compare.</param>
    /// <returns>True if the instances are not equal; otherwise, false.</returns>
    public static bool operator !=(ThemeColor? lhs, ThemeColor? rhs) => !(lhs == rhs);

    /// <summary>
    /// Determines whether two <see cref="ThemeColor"/> instances are equal.
    /// </summary>
    /// <param name="lhs">The first <see cref="ThemeColor"/> instance to compare.</param>
    /// <param name="rhs">The second <see cref="ThemeColor"/> instance to compare.</param>
    /// <returns>True if the instances are equal; otherwise, false.</returns>
    public static bool operator ==(ThemeColor? lhs, ThemeColor? rhs)
    {
    ...
    /// <summary>
    /// Converts a string representation of a color to a <see cref="ThemeColor"/> instance.
    /// </summary>
    /// <param name="input">The string representation of the color.</param>
    /// <returns>A new <see cref="ThemeColor"/> instance representing the color.</returns>
    public static implicit operator ThemeColor(string input) => Parse(input);

    /// <summary>
    /// Converts a <see cref="ThemeColor"/> instance to its string representation.
    /// </summary>
    /// <param name="ThemeColor">The Color instance to convert.</param>
    /// <returns>The string representation of the color.</returns>
    public static explicit operator string(ThemeColor? color) => color == null ? string.Empty : color.Value;

    /// <summary>
    /// Converts a <see cref="ThemeColor"/> instance to a 32-bit unsigned integer.
    /// </summary>
    /// <param name="ThemeColor">The Color instance to convert.</param>
    /// <returns>The 32-bit unsigned integer representation of the color.</returns>
    public static explicit operator uint(ThemeColor Color) => Color.UInt32;

    /// <summary>
    /// Parses a string representation of a color to a <see cref="ThemeColor"/> instance.
    /// </summary>
    ...
    public static ThemeColor Parse(string s, IFormatProvider? provider = null)
    {
    ...
    /// <summary>
    /// Tries to parse a string representation of a color to a <see cref="ThemeColor"/> instance.
    /// </summary>
    /// <param name="s">The string representation of the color.</param>
    /// <param name="provider">An optional format provider.</param>
    /// <param name="result">When this method returns, contains the <see cref="ThemeColor"/> instance equivalent to the color contained in <paramref name="s"/>, if the conversion succeeded, or <c>null</c> if the conversion failed.</param>
    /// <remarks>
    /// The color can be represented in various formats, including hexadecimal (with or without alpha), RGB, and RGBA.
    /// Examples of valid color strings:
    /// - Hexadecimal format: "#ab2a3d", "#ab2a3dff"
    ...
    public static bool TryParse([NotNullWhen(true)] string? s, IFormatProvider? provider, [MaybeNullWhen(false)] out ThemeColor result)
    {
    ...
    /// </remarks>
    /// <returns><c>true</c> if the string was successfully parsed; otherwise, <c>false</c>.</returns>
    public static bool TryParse([NotNullWhen(true)] string? s, [MaybeNullWhen(false)] out ThemeColor result) => TryParse(s, null, out result);
