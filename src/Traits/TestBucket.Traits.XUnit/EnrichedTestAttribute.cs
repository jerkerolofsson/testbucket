...
namespace TestBucket.Traits.Xunit
{
    public class EnrichedTestAttribute : BeforeAfterTestAttribute
    {
        ...
        private static void EnrichWithOperatingSystem()
        {
