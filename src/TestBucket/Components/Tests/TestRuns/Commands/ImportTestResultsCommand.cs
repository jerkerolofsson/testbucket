...
/// <summary>
/// Command for importing test results into the selected project.
/// </summary>
internal class ImportTestResultsCommand : ICommand
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ImportTestResultsCommand"/> class.
    /// </summary>
    ...
    public async ValueTask ExecuteAsync(ClaimsPrincipal principal)
    {
        ...
        await _browser.ImportResultsAsync(_appNavigationManager.State.SelectedTeam, _appNavigationManager.State.SelectedProject);
    }
}