...
internal class DefaultStrategy : IOrchestrationStrategy
{
    public string Name => OrchestrationStrategies.Default;
    ...
    {
        return [DefaultAgent.Create(kernel, loggerFactory)];
    }
}
