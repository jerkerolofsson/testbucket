...
{
    class StretchTargetSetting : SettingAdapter
    {
        private readonly ISettingsProvider _settingsProvider;

        public StretchTargetSetting(ISettingsProvider settingsProvider)
        {
            _settingsProvider = settingsProvider;

            Metadata.Name = "code-coverage-stretch-target";
        ...
        public override async Task<FieldValue> ReadAsync(SettingContext context)
        {
            ...
            return new FieldValue { LongValue = settings.StretchTarget, FieldDefinitionId = 0 };
        }
        ...
        public override async Task WriteAsync(SettingContext context, FieldValue value)
        {
            ...
            if (value.LongValue is not null && settings.StretchTarget != value.LongValue)
            {
                settings.StretchTarget = (int)value.LongValue.Value;
