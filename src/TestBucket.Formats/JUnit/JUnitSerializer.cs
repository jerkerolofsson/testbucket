...
namespace TestBucket.Formats.JUnit
{
    public class JUnitSerializer : ITestResultSerializer
    {
        ...
        public TestRunDto Deserialize(string xml)
        {
            ...
            if (testSuitesNode is not null)
            {
                ...
                foreach (var testSuiteNode in testSuitesNode.Elements("testsuite"))
                {
                    ...
                    ReadTestsFromSuite(testRun, testSuiteNode, testSuite, testSuite.Name??"", folders);
                }
            }
        ...
        private static void ReadTestsFromSuite(TestRunDto testRun, XElement testSuiteNode, TestSuiteRunDto testSuite, string testSuiteElementName, Stack<string> folders)
        {
            ...
            foreach (var innerTestSuiteNode in testSuiteNode.Elements("testsuite"))
            {
                ...
                ReadTestsFromSuite(testRun, innerTestSuiteNode, testSuite, name??"", folders);
