...
internal class AssignAllUnassignedToMe : ICommand
{
    ...
    public AssignAllUnassignedToMe(
    ...
    public string Id => "assign-all-unassigned-to-me";
    public string Name => _loc["assign-all-unassigned-to-me"];
    public string Description => _loc["assign-all-unassigned-to-me-description"];
